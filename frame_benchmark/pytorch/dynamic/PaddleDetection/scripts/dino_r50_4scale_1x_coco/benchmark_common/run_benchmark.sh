...
function _set_params(){
    ...
    max_iter=${7:-"1"}                # （可选）需保证模型执行时间在5分钟内，需要修改代码提前中断的直接提PR 合入套件  或是max_epoch
    num_workers=${8:-"2"}             # (可选)
...
function _train(){
    ...
    train_config="projects/dino/configs/dino_r50_4scale_12ep.py"
